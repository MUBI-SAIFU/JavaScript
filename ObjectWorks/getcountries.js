...
var report={};        // india:{population:123,language:hindi,currency:indianrupee}

for(let country of countries){
  let country_name=country.name;
  let popultn=country.population;
  let lang=country.languages[0].name;

  if(country.currencies){//because Antarctica have no currency
  let currncy=country.currencies[0].name;
  report[country_name]={popultn,lang,currncy}
}
...
//print details of a specific country using function
function getCountryDataByName(country_name){
return report[country_name];  //return country_name in report?report[country_name]:"invalid countr name"
}
console.log(getCountryDataByName("India"));



//print currency of a specific country
function getCurrencyByCountryName(country_name){
 return report[country_name].currncy
}
console.log(getCurrencyByCountryName("Qatar"))
